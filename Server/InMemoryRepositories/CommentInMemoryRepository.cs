...
public class CommentInMemoryRepository : ICommentRepository
{
    ...
    public Task UpdateAsync(Comment comment)
    {
        ...
        if (existing is null) throw new InvalidOperationException($"Comment {comment.Id} not found");
    ...
    public Task DeleteAsync(int id)
    {
        ...
        if (toRemove is null) throw new InvalidOperationException($"Comment {id} not found");

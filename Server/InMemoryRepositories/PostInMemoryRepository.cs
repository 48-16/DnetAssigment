...
public class PostInMemoryRepository : IPostRepository
{
    ...
    public Task UpdateAsync(Post post)
    {
        ...
        if (existing is null) throw new InvalidOperationException($"Post {post.Id} not found");
    ...
    public Task DeleteAsync(int id)
    {
        ...
        if (toRemove is null) throw new InvalidOperationException($"Post {id} not found");
